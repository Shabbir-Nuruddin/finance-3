...
export const PROFILE: Profile = {
  ...
  holdings: [
    ...
    { ticker: "NVDA", name: "NVIDIA", value: 5900, weight: 8, ret1y: 48.7, kind: "stock" },
    { ticker: "BTC", name: "Bitcoin", value: 5200, weight: 7, ret1y: 62.0, kind: "crypto" },
    { ticker: "CASH", name: "Settlement Cash", value: 2900, weight: 4, ret1y: 4.8, kind: "cash" },
  ],
  bills: [
